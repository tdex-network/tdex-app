...
import { IconBack, IconClose, IconExchange, IconQR } from '../../components/icons';
    ...
    <IonPage>
      ...
      <IonContent className="withdrawal">
        ...
        <div className="buttons">
            <IonButton onClick={() => {setOpenModal(true)}} className="main-button"><IonLabel>Confirm</IonLabel></IonButton>
        </div>
...
you’ve set at sign in</p>
            ...
            <PinInput inputRef={inputRef} inputValue={inputValue} onChange={onChange} />
            <div className="buttons">
              <IonButton routerLink="/withdrawaldetails" onClick={() => {setOpenModal(false)}} className="main-button">Confirm</IonButton>
            </div>
          </IonContent>
        </IonModal>
      </IonContent>

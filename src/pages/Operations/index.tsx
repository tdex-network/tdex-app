import {  IonPage, IonButtons, IonTitle,  IonContent, IonList, IonItem, IonButton, IonToolbar, IonHeader, IonListHeader } from '@ionic/react';
      ...
      <IonHeader className="header operations">
        <IonToolbar className="with-back-button">
          ...
          <IonButtons className="operations-buttons">
            <IonButton className="coin-action-button" routerLink="/recieve">Recieve</IonButton>
            <IonButton className="coin-action-button" routerLink="/withdraw">Withdraw</IonButton>
            <IonButton className="coin-action-button" routerLink="/swap">Swap</IonButton>
          </IonButtons>
      </IonHeader>
      <IonContent>
        <IonList>

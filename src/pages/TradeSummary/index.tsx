        ...
        <IonItem>
          ...
          <div className="transaction-info">
            ...
            <div className="transaction-info-values">
              ...
              <div className="transaction-col-value">8T71hMKw05f96b4dc1gBrLO4ds1f3LMKSX</div>
            </div>
            <div className="transaction-info-values">
              <div className="transaction-col-name">T x ID</div>
              <div className="transaction-col-value">84g96f5hy6mu13971563f95f08gh818s3526h7dpv22d1r006hn8563247855690</div>
            </div>
          </div>
          </div>
        </IonItem>
        <div className="buttons">
          <IonButton routerLink="/history" className="main-button secondary">Go to trade history</IonButton>
        </div>
      </IonContent>
    </IonPage>
  );

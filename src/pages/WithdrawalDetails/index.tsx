import {  IonPage, IonTitle,  IonContent, IonItem, IonButton, IonToolbar, IonHeader } from '@ionic/react';
      ...
      <IonContent className="withdrawal-details">
        ...
        <IonItem>
          ...
          <div className="item-main-info">
            <div className="item-start main-row">
              Amount
            </div>
        ...
        <div className="buttons">
          <IonButton routerLink="/history" className="main-button secondary">Go to transactions</IonButton>
        </div>
      </IonContent>
    </IonPage>
  );

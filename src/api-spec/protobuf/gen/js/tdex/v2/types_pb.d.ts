...
declare class UnblindedInput$Type extends MessageType<UnblindedInput> {
    constructor();
 ...
 */
export declare const UnblindedInput: UnblindedInput$Type;
...
declare class MarketFee$Type extends MessageType<MarketFee> {
    constructor();
 ...
 */
export declare const MarketFee: MarketFee$Type;
